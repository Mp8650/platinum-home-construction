...
const expertiseAreas: ExpertiseArea[] = [
  {
    ...
    description:
      "Transform unfinished basements into functional, stylish living spaces with flooring, lighting, and full finishing.",
    color: "orange",
  ...
  },
  {
    ...
    description:
      "Upgrade interiors with modern layouts, flooring, walls, and lighting for a clean, comfortable home.",
    color: "green",
  ...
  },
  {
    ...
    description:
      "Sustainable renovation practices using energy-efficient materials and eco-conscious design solutions.",
    color: "emerald",
  ...
  },
  {
    ...
    description:
      "Every project follows strict safety standards and quality controls to ensure reliable, long-lasting results.",
    color: "indigo",
  ...
  },
  {
    ...
    description:
      "Professional guidance from planning to execution, ensuring your renovation meets your vision and goals.",
    color: "slate",
  ...
  },
  {
    ...
    description:
      "Tailored home upgrades and improvements that enhance functionality, style, and long-term value for your property.",
    color: "blue",
...
const capabilities: Capability[] = [
  ...
  },
  {
    ...
    title: "Skilled Team",
    description:
      "Certified professionals dedicated to modern design and precise craftsmanship",
  },
  {
    icon: TrendingUp,
    title: "Proven Results",
    description:
      "Hundreds of satisfied homeowners with beautifully renovated homes",
  },
  {
    icon: Wrench,
    title: "Advanced Techniques",
    description:
      "Modern renovation methods, high-quality materials, and smart home solutions",
  },
];
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-orange-900 text-white py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Delivering premium construction solutions across Canada with
            precision, safety, and innovation at every stage
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Six core areas of expertise that define our construction leadership
            across Canada
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {expertiseAreas.map((area, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`p-8 ${colors.hover} transition-colors duration-300`}
                >
            ...
            {[
              {
                ...
                title: "Consultation",
                description:
                  "Discuss renovation goals and project requirements.",
                bg: "bg-slate-100",
                text: "text-slate-800",
              },
              {
              ...
              },
              {
                ...
                title: "Construction",
                description:
                  "Professional renovation work with attention to detail.",
                bg: "bg-amber-100",
                text: "text-amber-800",
              },
              {
              ...
              <div key={idx} className="relative">
                <div
                  className={`${phase.bg} ${phase.text} text-sm rounded-2xl p-6 shadow-lg`}
                >
      ...
      <section className="bg-gradient-to-br from-orange-600 to-orange-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-orange-100 mb-10 max-w-2xl mx-auto">
            Talk to our construction experts and get a free consultation with
