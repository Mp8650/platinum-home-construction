...
const services = [
  ...
  },
  {
    ...
    desc: "Our interior renovation services help homeowners update and improve their living spaces. From flooring and walls to lighting and layout improvements, we create clean and modern interiors.",
  ...
  },
  {
    ...
    desc: "We also assist with various home improvement projects that enhance the functionality and appearance of your property",
    icon: Wrench,
